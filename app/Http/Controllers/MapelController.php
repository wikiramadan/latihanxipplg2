...
class MapelController extends Controller
{
    ...
    public function create()
      ...
      public function store(Request $request)
      {
         ...
         DB::table('mapels')->insert([
          ...
          if(DB::table('mapels'))
          {
             return redirect()->route('mapel.index')->with(['success'=>'Data 
              berhasil disimpan']);
           }else
           {
           return redirect()->route('mapel.index')->with(['error'=>'Data gagal 
           disimpan']);
         } 
      }
    ...
    if($mapel){ 
        ...
        return 	redirect()->route('mapel.index')->with(['success'=>'Data 	berhasil disimpan']);         }else{ 
